...
MODEL                := PID_CorSys_Ctrl
MODULES              := rt_matrx.c rt_printf.c PID_CorSys_Ctrl_data.c PID_CorSys_Ctrl_tgtconn.c rtGetInf.c rtGetNaN.c rt_nonfinite.c
MAKEFILE             := PID_CorSys_Ctrl.mk
...
#
MODELLIB                  := PID_CorSys_Ctrllib_sldrt.lib
MODELREF_LINK_LIBS        := 
MODELREF_LINK_RSPFILE     := PID_CorSys_Ctrl_ref.rsp
MODELREF_INC_PATH         := 
...
# additional includes
REQ_INCLUDES += ;C:/Users/optiplex3060/Desktop/ECE486-lab04_Student;C:/Users/optiplex3060/Desktop/ECE486-lab04_Student/PID_CorSys_Ctrl_sldrt_win64;$(MATLAB_ROOT)/extern/include;$(MATLAB_ROOT)/simulink/include;$(MATLAB_ROOT)/rtw/c/src;$(MATLAB_ROOT)/rtw/c/src/ext_mode/common
