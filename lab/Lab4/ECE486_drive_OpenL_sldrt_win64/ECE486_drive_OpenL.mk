...
MODEL                := ECE486_drive_OpenL
MODULES              := rt_matrx.c rt_printf.c ECE486_drive_OpenL_data.c ECE486_drive_OpenL_tgtconn.c rtGetInf.c rtGetNaN.c rt_nonfinite.c
MAKEFILE             := ECE486_drive_OpenL.mk
MATLAB_ROOT          := E:/Program Files/MATLAB/R2018b
MATLAB_BIN           := E:/Program Files/MATLAB/R2018b/bin
S_FUNCTIONS          := gts_getpos.c gts_initialize_m.c gts_setdac.c
S_FUNCTIONS_LIB      := 
SOLVER               := 
NUMST                := 2
TID01EQ              := 1
...
#
MODELLIB                  := ECE486_drive_OpenLlib_sldrt.lib
MODELREF_LINK_LIBS        := 
MODELREF_LINK_RSPFILE     := ECE486_drive_OpenL_ref.rsp
MODELREF_INC_PATH         := 
...
# additional includes
REQ_INCLUDES += ;C:/Users/optiplex3060/Desktop/ECE486-lab04_Student;C:/Users/optiplex3060/Desktop/ECE486-lab04_Student/ECE486_drive_OpenL_sldrt_win64;$(MATLAB_ROOT)/extern/include;$(MATLAB_ROOT)/simulink/include;$(MATLAB_ROOT)/rtw/c/src;$(MATLAB_ROOT)/rtw/c/src/ext_mode/common
